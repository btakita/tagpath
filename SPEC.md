...
- The fixture covers three tsift preview surfaces: `search`, `explain`, and `session-review`.
...
- Tests must verify that raw symbols parse back to the fixture family counts, aliases are generated by tagpath rather than hand-maintained drift, and compact previews satisfy each case's savings threshold.
