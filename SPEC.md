...
- Tests must verify that raw symbols parse back to the fixture family counts, aliases are generated by tagpath rather than hand-maintained drift, `context-pack` carries ontology/summary/artifact handles, and compact previews satisfy each case's savings threshold.
